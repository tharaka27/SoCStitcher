...
// ==============================================================
#ifndef __warp_stream_accelb0s__HH__
#define __warp_stream_accelb0s__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(warp_stream_accelb0s) {
    ...
    SC_CTOR(warp_stream_accelb0s):  simcore_mac_0_U ("simcore_mac_0_U") {
