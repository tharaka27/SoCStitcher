...
// ==============================================================
#ifndef __warp_stream_accelbTr__HH__
#define __warp_stream_accelbTr__HH__
#include "ACMP_fdiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(warp_stream_accelbTr) {
    ...
    SC_CTOR(warp_stream_accelbTr):  ACMP_fdiv_U ("ACMP_fdiv_U") {
        ACMP_fdiv_U.clk(clk);
