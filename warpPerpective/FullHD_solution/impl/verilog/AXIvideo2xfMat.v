...
output  [11:0] img_rows_out_din;
input   img_rows_out_full_n;
output   img_rows_out_write;
output  [11:0] img_cols_out_din;
...
wire   [0:0] tmp_138_i_fu_367_p2;
wire   [0:0] brmerge_i_fu_381_p2;
wire    ap_CS_fsm_state8;
wire   [0:0] ap_phi_mux_eol_2_i_phi_fu_322_p4;
reg    img_rows_blk_n;
reg    img_cols_blk_n;
reg    img_data_V_blk_n;
reg    ap_enable_reg_pp1_iter1;
reg   [0:0] tmp_138_i_reg_431;
reg    img_rows_out_blk_n;
reg    img_cols_out_blk_n;
reg   [0:0] eol_reg_224;
reg   [7:0] axi_data_V_1_i_reg_235;
reg   [0:0] eol_i_reg_246;
reg   [10:0] j_i_reg_258;
reg   [0:0] axi_last_V_2_i_reg_269;
reg   [7:0] p_Val2_s_reg_282;
reg   [11:0] img_rows_read_reg_392;
reg    ap_block_state1;
reg   [11:0] img_cols_read_reg_397;
reg   [7:0] tmp_data_V_reg_402;
reg   [0:0] tmp_last_V_reg_410;
wire   [0:0] tmp_137_i_fu_352_p2;
wire    ap_CS_fsm_state4;
wire   [10:0] i_fu_357_p2;
reg   [10:0] i_reg_426;
reg    ap_predicate_op65_read_state5;
reg    ap_block_state5_pp1_stage0_iter0;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [10:0] j_fu_372_p2;
reg    ap_block_state8;
reg    ap_block_pp1_stage0_subdone;
reg    ap_condition_pp1_exit_iter0_state5;
reg   [0:0] axi_last_V_3_i_reg_295;
reg   [0:0] axi_last_V1_i_reg_193;
wire    ap_CS_fsm_state9;
wire    ap_CS_fsm_state3;
reg   [7:0] axi_data_V_3_i_reg_307;
reg   [7:0] axi_data_V1_i_reg_203;
reg   [10:0] i_i_reg_213;
reg   [0:0] ap_phi_mux_eol_phi_fu_227_p4;
reg   [7:0] ap_phi_mux_axi_data_V_1_i_phi_fu_238_p4;
reg   [0:0] ap_phi_mux_eol_i_phi_fu_250_p4;
wire   [0:0] ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_269;
wire   [7:0] ap_phi_reg_pp1_iter0_p_Val2_s_reg_282;
wire    ap_CS_fsm_state7;
reg   [0:0] eol_2_i_reg_319;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_fu_136;
wire   [11:0] i_cast_cast_i_fu_348_p1;
wire   [11:0] j_cast_cast_i_fu_363_p1;
wire   [0:0] tmp_user_V_fu_339_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((tmp_137_i_fu_352_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((tmp_137_i_fu_352_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (tmp_138_i_reg_431 == 1'd1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((eol_2_i_reg_319 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_319 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_568)) begin
        if (((brmerge_i_fu_381_p2 == 1'd1) & (tmp_138_i_fu_367_p2 == 1'd1))) begin
            axi_last_V_2_i_reg_269 <= ap_phi_mux_eol_phi_fu_227_p4;
        end else if (((tmp_138_i_fu_367_p2 == 1'd1) & (brmerge_i_fu_381_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (tmp_138_i_fu_367_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((~((eol_2_i_reg_319 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_319 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_predicate_op65_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if ((tmp_138_i_fu_367_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((tmp_137_i_fu_352_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((tmp_138_i_reg_431 == 1'd1) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_319 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((tmp_138_i_fu_367_p2 == 1'd1) & (brmerge_i_fu_381_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_339_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_339_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((1'b0 == ap_block_pp1_stage0_subdone) & (tmp_138_i_fu_367_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((1'b0 == ap_block_pp1_stage0_subdone) & (tmp_138_i_fu_367_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((eol_2_i_reg_319 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_319 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((eol_2_i_reg_319 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (ap_phi_mux_eol_2_i_phi_fu_322_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((tmp_138_i_reg_431 == 1'd1) & (img_data_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op65_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((tmp_138_i_reg_431 == 1'd1) & (img_data_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op65_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((tmp_138_i_reg_431 == 1'd1) & (img_data_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op65_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = ((tmp_138_i_reg_431 == 1'd1) & (img_data_V_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state8 = ((eol_2_i_reg_319 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end
...
assign ap_phi_mux_eol_2_i_phi_fu_322_p4 = eol_2_i_reg_319;

assign ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_269 = 'bx;

assign ap_phi_reg_pp1_iter0_p_Val2_s_reg_282 = 'bx;

always @ (*) begin
    ap_predicate_op65_read_state5 = ((tmp_138_i_fu_367_p2 == 1'd1) & (brmerge_i_fu_381_p2 == 1'd0));
end

assign brmerge_i_fu_381_p2 = (sof_1_i_fu_136 | ap_phi_mux_eol_i_phi_fu_250_p4);

assign i_cast_cast_i_fu_348_p1 = i_i_reg_213;

assign i_fu_357_p2 = (i_i_reg_213 + 11'd1);

assign img_cols_out_din = img_cols_dout;

assign img_data_V_din = p_Val2_s_reg_282;

assign img_rows_out_din = img_rows_dout;

assign j_cast_cast_i_fu_363_p1 = j_i_reg_258;

assign j_fu_372_p2 = (j_i_reg_258 + 11'd1);

assign p_src_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign tmp_137_i_fu_352_p2 = (($signed(i_cast_cast_i_fu_348_p1) < $signed(img_rows_read_reg_392)) ? 1'b1 : 1'b0);

assign tmp_138_i_fu_367_p2 = (($signed(j_cast_cast_i_fu_363_p1) < $signed(img_cols_read_reg_397)) ? 1'b1 : 1'b0);

assign tmp_user_V_fu_339_p1 = AXI_video_strm_V_user_V_0_data_out;
