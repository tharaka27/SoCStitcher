...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { p_dst_TDATA { O 8 vector } p_dst_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { p_dst_TVALID { O 1 bit } p_dst_TDEST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_data_V_dout { I 8 vector } img_data_V_empty_n { I 1 bit } img_data_V_read { O 1 bit } } \
} "
}
