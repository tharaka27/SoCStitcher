...
set out_width 23
set exp i0*i1
set arg_lists {i0 {23 1 +} i1 {8 0 +} p {23 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 23
set exp i0*i1+i2
set arg_lists {i0 {23 1 +} i1 {8 0 +} m {23 1 +} i2 {16 0 +} p {23 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 23
set exp i0*i1+i2
set arg_lists {i0 {23 1 +} i1 {8 0 +} m {23 1 +} i2 {23 1 +} p {23 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set ID 86
set hasByteEnable 0
set MemName warpTransform_Blocud
...
set ID 87
set hasByteEnable 0
set MemName warpTransform_BlodEe
set CoreName ap_simcore_mem
set PortList { 1 1 }
set DataWd 53
set AddrRange 64
...
set ID 88
set hasByteEnable 0
set MemName warpTransform_BloeOg
set CoreName ap_simcore_mem
set PortList { 0 1 }
set DataWd 8
set AddrRange 1920
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename P_matrix \
    op interface \
    ports { P_matrix_address0 { O 4 vector } P_matrix_ce0 { O 1 bit } P_matrix_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'P_matrix'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_stream_V_V_dout { I 8 vector } in_stream_V_V_empty_n { I 1 bit } in_stream_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_stream_V_V_din { O 8 vector } out_stream_V_V_full_n { I 1 bit } out_stream_V_V_write { O 1 bit } } \
} "
}
