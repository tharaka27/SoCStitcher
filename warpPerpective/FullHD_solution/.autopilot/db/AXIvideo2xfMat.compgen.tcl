...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { p_src_TVALID { I 1 bit } p_src_TREADY { O 1 bit } p_src_TDEST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_rows_dout { I 12 vector } img_rows_empty_n { I 1 bit } img_rows_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_cols_dout { I 12 vector } img_cols_empty_n { I 1 bit } img_cols_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_data_V_din { O 8 vector } img_data_V_full_n { I 1 bit } img_data_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_rows_out_din { O 12 vector } img_rows_out_full_n { I 1 bit } img_rows_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_cols_out_din { O 12 vector } img_cols_out_full_n { I 1 bit } img_cols_out_write { O 1 bit } } \
} "
}
