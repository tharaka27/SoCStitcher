...
proc create_root_design { parentCell } {
  ...
  set p_dst_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 p_dst_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {50000000} \
   ] $p_dst_0
  set p_dst_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 p_dst_1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {50000000} \
   ] $p_dst_1
  set p_src_1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 p_src_1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {50000000} \
   CONFIG.HAS_TKEEP {1} \
   CONFIG.HAS_TLAST {1} \
  ...
  # Create instance: warp_stream_accel_0, and set properties
  set warp_stream_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:warp_stream_accel:1.0 warp_stream_accel_0 ]

  # Create instance: warp_stream_accel_0_bram, and set properties
  set warp_stream_accel_0_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 warp_stream_accel_0_bram ]
  set_property -dict [ list \
 ...
 ] $warp_stream_accel_0_bram

  # Create interface connections
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins warp_stream_accel_0_bram/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins warp_stream_accel_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net p_src_1_1 [get_bd_intf_ports p_src_1] [get_bd_intf_pins warp_stream_accel_0/p_src]
  ...
  connect_bd_intf_net -intf_net warp_stream_accel_0_R_PORTA [get_bd_intf_pins warp_stream_accel_0/R_PORTA] [get_bd_intf_pins warp_stream_accel_0_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net warp_stream_accel_0_p_dst [get_bd_intf_ports p_dst_1] [get_bd_intf_pins warp_stream_accel_0/p_dst]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins warp_stream_accel_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins warp_stream_accel_0/ap_rst_n]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs warp_stream_accel_0/s_axi_AXILiteS/Reg] SEG_warp_stream_accel_0_Reg
